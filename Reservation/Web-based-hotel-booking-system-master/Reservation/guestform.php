...
<meta name="reservation hotel Aicha" >
...
<div class="large-12 columns">
		<div class="large-3 columns centerdiv">
			...
			<p class="fontgrey">Sélectionnez la date</p>
		</div>
		<div class="large-3 columns centerdiv">
			<a href="unsetroomchosen.php" class="button round blackblur fontslabo" >2</a>
			<p class="fontgrey">Sélectionnez une chambre</p>
		</div>
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#b7995d;">3</a>
			<p class="fontgrey">Détails des invités</p>
		</div>
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round blackblur fontslabo" >4</a>
			<p class="fontgrey">Confirmation</p>
		</div>
</div>
...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<div class="large-12 columns " >
		<p><b>Ma Reservation</b></p><hr class="line">
				...
				<div class="row">
					<div class="large-12 columns">
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall">Adultes
								</span>
							</div>
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall">Enfants
								</span>
							</div>
						...
						<div class="row">
							<div class="large-5 columns" style="max-width:100%;">
								<span class="fontgreysmall" >Nombre de nuits
								</span>
							</div>
						...
						<div class="row"><hr>
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgreysmall" >Chambres Selectionées 
								</span>
							</div>
							
							<div class="large-4 columns" style="max-width:100%;">
								<span class="fontgreysmall">Qté
								</span>				
				...
				<div class="row">					
						<div class="large-12 columns" style="max-width:100%;">
							...
							<span class="fontgrey" style="text-align:center;">Total</span><br>
							<span class="fontslabo" style="font-size:32px; text-align:center;"><?php echo $_SESSION['total_amount'];?>DHS</span></p>
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<button name="submit" href="#" class="button small fontslabo" style="background-color:#b7995d; width:100%;">Modifier la réservation</button>
					</div>
				  </div>
				</form>
		</div>
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		<p><b>Détails des invités</b><hr class="line"></p>
		<form action="insertandemail.php" method="post"  onSubmit="return validateForm(this);">
		  <div class="row">

			<div class="large-6 columns">
			  <label class="fontcolor">Prénom*
				<input name="firstname" type="text" value="<?php if(isset($_SESSION['firstname']) && !empty($_SESSION['firstname'])){echo  $_SESSION['firstname'];}?>" pattern="[a-zA-Z\s]+" Title="Seuls les caractères alphabétiques sont autorisés" placeholder="" />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="fontcolor">Nom*
				<input name="lastname" type="text" value="<?php if(isset($_SESSION['lastname']) && !empty($_SESSION['lastname'])){echo  $_SESSION['lastname'];}?>" pattern="[a-zA-Z\s]+" Title="Seuls les caractères alphabétiques sont autorisés" placeholder="" />
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Addresse e-mail*
				<input name="email" type="email" value="<?php if(isset($_SESSION['email']) && !empty($_SESSION['email'])){echo  $_SESSION['email'];}?>" placeholder="" />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="style="color="black"">Téléphone*
				<input name="phone" type="text" id="phone" value="<?php if(isset($_SESSION['phone']) && !empty($_SESSION['phone'])){echo  $_SESSION['phone'];}?>" pattern= "[^a-zA-Z]+" Title="Seuls les nombres sont autorisés"  placeholder="" size="35"/>
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Addresse 1*
			...
			<div class="large-6 columns">
			  <label class="fontcolor">Addresse 2
		  ...
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Code postal / Zip *
				<input name="postcode" type="text"  value="<?php if(isset($_SESSION['postcode']) && !empty($_SESSION['postcode'])){echo  $_SESSION['postcode'];}?>" pattern= "[a-zA-Z0-9\s]+" Title="Les caractères spéciaux tels que () * & ^% $ & etc ne sont pas autorisés><;"  placeholder=""/ />
			  </label>
			</div>
			<div class="large-6 columns">
			  <label class="fontcolor">Ville*
				<input name="city" type="text"  value="<?php if(isset($_SESSION['city']) && !empty($_SESSION['city'])){echo  $_SESSION['city'];}?>" pattern= "[a-zA-Z0-9\s]+" Title="Les caractères spéciaux tels que () * & ^% $ & etc ne sont pas autorisés"  placeholder=""/ />
			  </label>
			</div>
		  </div>
		  <div class="row">
			<div class="large-6 columns">
			  <label class="fontcolor">Etat
		  ...
		  <div class="row">
			<div class="large-12 columns">
			  <label class="fontcolor">Exigences particulières
		  ...
		  <div class="row">
			<div class="large-12 columns" style="text-align:right;"><button type="submit" class="button small fontslabo" style="background-color:#b7995d;" onclick="return confirm('Etes-vous sur de vouloir continuer?')" >Confirmer</button>
		  </div>
...
<script>
	function validateForm(form) {
		...
		var country = form.country.value;
			if(fname == null || lname == null || email == null || phone == null || add1 == null || postcode == null|| city == null|| country == null || fname == "" || lname == "" || email == "" || phone == "" || add1 == "" || postcode == "" || city == "" || country == "") 
			{
