	...
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<p><b>Your Reservation</b></p><hr>
				...
				<div class="row">
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<button name="submit" href="#" class="button small fontslabo" style="background-color:#b7995d; width:100%;" >Edit Reservation</button>
					</div>
				  </div>
				</form>
		</div>
					...
					<div class="row">
						...
						<span style="text-align:right;">6 room available</span>
							...
							<div class="row">
								...
								<div class="large-6 columns">
									<button type="submit"  class="book button small" style="background-color:#b7995d; width:100%; height:45px; !important;" onchange="validateClick(this);">Book</button>
								</div>
							</div>
						</div>
					...
					<div class="row">
						...
						<span style="text-align:right;">6 room available</span>
							...
							<div class="row">
								...
								<div class="large-6 columns">
									<button type="submit" id="room7" class="book button small" style="background-color:#b7995d; width:100%; height:45px; !important;" onclick="validateClick(this);">Book</button>
								</div>
							</div>
						</div>
