...
<title>Reservation Hotel Aicha</title>
...
<body class="fontbody" style="background-image : url(img/bg-home2.jpg); no-repeat center center fixed; background-size: cover;">
 
<div class="row foo" style="margin:30px auto 30px auto;"><br><br>
<!--div class="large-12 columns">
		<div class="large-3 columns centerdiv">
			<a href="index.php" class="button round fontslabo" style="background-color:#b7995d;">1</a>
...
<div class="row">
	...
	<div class="large-12 columns " >
	<p><b>Ma réservation</b></p><hr class="line">
			...
			<div class="row">
			  ...
			  <div class="row">
				<div class="large-12 columns" >
					<button name="submit" href="#" class="button small fontslabo" style="background-color:#b7995d; width:100%;" >Voir les disponibilités</button>
				</div>
			  </div>
			</form>
	</div>
	...
	function validateForm(form) {
		...
		var d = form.totalchildrens.value;
			...
			if(c == 0) 
			{
			 	if(d == 0) 
				{
				 alert("Veuillez choisir le nombre d'invités");
				 return false;
				}
			}
			if(d == 0) 
