...
<div class="large-12 columns">
		...
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round fontslabo" style="background-color:#b7995d;">2</a>
...
<div class="row">
	<div class="large-4 columns blackblur fontcolor" style="margin-left:-10px; padding:10px;">
		...
		<p><b>Ma Reservation</b></p><hr class="line">
				...
				<div class="row">
					<div class="large-12 columns">
						...
						<div class="row">
							<div class="large-6 columns" style="max-width:100%;">
								<span class="fontgrey" style="font-size:13.2px;">Nombre de nuits
								</span>
							</div>
				  ...
				  <div class="row">
					<div class="large-12 columns" >
						<br><button name="submit" href="#" class="button small fontslabo" style="background-color:#b7995d; width:100%;" >Modifier la réservation</button>
					</div>
				  </div>
				</form>
		</div>
		<div class="large-12 columns" id="roomselected" style="display:none;" >
				<hr>
							<br><label for="submit-form" class="book button small fontslabo" style="background-color:#b7995d; width:100%; height:45px; !important;">Procéder à la réservation</label><!--button name="submit" href="#" class="button small fontslabo" style="background-color:#b7995d; width:100%;" >Proceed Booking</button-->
		...
		<div class="large-12 columns" >
			<?php
				...
				if(mysqli_num_rows($result) > 0){
					echo "<p><b>Choisissez votre chambre</b></p><hr class=\"line\">";
					...
					while ($row = mysqli_fetch_array($result)) {
						...
						if($row['availableroom'] != null && $row['availableroom'] > 0  )
						{
							...
							if(mysqli_num_rows($sub_result) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p><span class=\"fontgrey\">Occupation : </span> ".$sub_row['occupancy']."<br>\n";
								print "						<span class=\"fontgrey\">Superficie : </span> ".$sub_row['size']."\n";
								print "						<br><span class=\"fontgrey\">Vue : </span> ".$sub_row['view']."</p>\n";
								print "\n";
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Prix :</span><span style=\"font-size:24px;\">".$sub_row['rate']."</span><span class=\"fontgrey\"> DHS / night</span><br>\n";
								print "						<span style=\"text-align:right;\">".$row['availableroom']." chambres disponibles</span>\n";
								print "						</p>\n";
								print "							<div class=\"row\">\n";
							...
							if(mysqli_num_rows($sub_result2) > 0)
							{
								...
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p><span class=\"fontgrey\">Occupation : </span> ".$sub_row2['occupancy']."<br>\n";
								print "						<span class=\"fontgrey\">Superficie : </span> ".$sub_row2['size']."\n";
								print "						<br><span class=\"fontgrey\">Vue : </span> ".$sub_row2['view']."</p>\n";
								print "\n";
								print "						</div>\n";
								print "						<div class=\"large-4 columns\">\n";
								print "						<p ><span class=\"fontgrey\">Prix : </span><span style=\"font-size:24px;\">".$sub_row2['rate']."</span><span class=\"fontgrey\"> DHS / night</span><br>\n";
								print "						<span style=\"text-align:right;\">".$sub_row2['total_room']." chambres disponibles</span>\n";
								print "						</p>\n";
								print "							<div class=\"row\">\n";
								print "								<div class=\"large-11 columns\">\n";
								print "									<label class=\"fontcolor\">\n";
								...
								//print "				<button type=\"submit\"  class=\"book button small\" style=\"background-color:#b7995d; width:100%; height:45px; !important;\" >Book</button>\n";	
								print "								</div>\n";
								print "							</div>\n";
								print "						</div>\n";
								print "						\n";
				...
				echo "<p><b>Pas de chambres disponibles</b></p><hr>";
				}
