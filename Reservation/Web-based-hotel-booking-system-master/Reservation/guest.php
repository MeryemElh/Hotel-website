...
<div class="large-12 columns">
		...
		<div class="large-3 columns centerdiv">
			<a href="#" class="button round blackblur" style="background-color:#b7995d;">3</a>
		</div>
		<div class="large-3 columns centerdiv">
...
<div class="row">
	...
	<div class="large-8 columns blackblur fontcolor" style="padding-top:10px;">
		...
		<form>
		  ...
		  <div class="row">
			<div class="large-12 columns" >
				<input type="button" id="paysubmit" class="button small" style="background-color:#b7995d;" onclick="addStorage();"><b>Book Now and Pay Deposit</b></a>
			</div>
		  </div>
		</form>
